...
if "%~1" == "" (
    ...
    echo Example parameters : -p 9112 -e 10240 -r 30 -b 1 -w 5 -s 1 -n 50 -c d:\tmp\testKVCheckDir -d 1    2^>^&1  ^| lzmw -it "exception|\b(begin|end).{1,5}test|finished all|used time|args.\d+" -e "\bmemory|\d+\.?\d*\s*[MG]B" -P
